        ...
        <div>
            <Layout>
              ...
              <Layout>
                ...
                <br/>
                <h2 style={{position:'absolute', left:900,color:"#434343",top:3550,fontWeight:'bold',fontSize:'40px',fontFamily:'Verdana'}}>{ML("YATIRIM_YAPMAYA_BASLAYIN")}</h2><br/>
                <h2 style={{position:'absolute', left:730,color:"#434343",top:3630,fontSize:'25px',fontFamily:'Verdana', textAlign:'center',zIndex:1}}>{ML("EN_GUVENILIR_KRIPTO_PARA_BIRIMLERINDEN_OLAN_ETHEREUM_ILE_BIRIKIMINIZ")} 
