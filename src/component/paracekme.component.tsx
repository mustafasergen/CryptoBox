        ...
        <Layout>
          ...
          >
            <Card.Grid style={{ width: '1000px', height: '650px', position: 'absolute', left: 680, top: 265, backgroundColor: '#E6FFFB' }}>
              ...
              <Input onChange={handlechangePullMoney} style={{ position: 'absolute', left: 430, marginTop: '210px', width: '200px', height: '80px' }} placeholder="" />
              ...
              <Link to="/basari" ><Button style={{ position: 'absolute', left: 350, marginTop: '380px', width: '350px', height: '80px', backgroundColor: '#13C2C2', fontSize: '35px', borderColor: '#13C2C2' }} type="primary" >Ethereum Çek</Button></Link>
