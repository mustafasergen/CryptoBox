            ...
            <Layout>
              <Header style={{background:"white", padding:50,position:'sticky', top:0, zIndex: 100,}}>
               ...
               <Button style={{position:'absolute', right:450, top:25, color:'#04ADBF', fontWeight:'bold',fontSize:'25px'}}
                ...
                type="link" danger><Link to="/">HAKKIMIZDA</Link></Button>    
              ...
              <Layout>
                ...
                >
                <h2 style={{position:'absolute', right:920, top:720}}>Please select metaMesk account as Ether.Js</h2>
                <Button style={{position:'absolute', right:1000,top:800,  width:'300px', height:'120px', color:'white',fontWeight:'bold',fontSize:'15px', backgroundColor:'orange', borderColor:'#04ADBF' }} 
                
                type="primary">Login with MetaMask</Button>
                </Content>
