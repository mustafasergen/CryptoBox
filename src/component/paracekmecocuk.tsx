        ...
        <Layout>
          ...
          >
            <Card.Grid style={{ width: '1000px', height: '650px', position: 'absolute', left: 680, top: 265, backgroundColor: '#E6FFFB' }}>
              ...
              <Input onChange={handlechangePullMoneyFrom} style={{ position: 'absolute', left: 430, marginTop: '140px', width: '200px', height: '80px' }} placeholder="Adress" />
              <Input onChange={handlechangePullMoney} style={{ position: 'absolute', left: 430, marginTop: '260px', width: '200px', height: '80px' }} placeholder={ML("TUTAR")} />
              ...
              <Link to="/basari" ><Button onClick={() => { withdrawParentFunction(); }} style={{ position: 'absolute', left: 350, marginTop: '380px', width: '370px', height: '80px', backgroundColor: '#13C2C2', fontSize: '35px', borderColor: '#13C2C2' }} type="primary" >{ML("ETHEREUM_CEK")}</Button></Link>
