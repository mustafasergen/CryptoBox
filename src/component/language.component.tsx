...
export default function LanguageComponent(props: LanguageProps) {
  ...
  return <>
    <Dropdown overlay={menu}>
      ...
      <Button style={{ position: 'absolute', left: 2050, top: 30, width: '280', height: '30px', color: 'white', fontWeight: 'bold', fontSize: '15px', backgroundColor: '#13C2C2', borderColor: '#13C2C2' }}
